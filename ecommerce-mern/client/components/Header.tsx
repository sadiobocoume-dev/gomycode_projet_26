    ...
    return (
        <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-slate-100 shadow-sm">
            <div className="max-w-6xl mx-auto px-4 h-16 flex items-center gap-4">
                ...
                {/* Logo */}
                <Link href="/" className="text-xl font-bold text-teal-600 hover:text-teal-700 transition shrink-0">
                ...
                <div className="flex items-center gap-3 ml-auto">
                    ...
                    <button
                        ...
                        className="md:hidden text-slate-500 hover:text-teal-600 transition"
            ...
            {searchOpen && (
                <div className="md:hidden px-4 pb-3 border-t border-slate-100">
                    <form
                        onSubmit={handleSearch}
                        className="flex items-center bg-slate-50 border border-slate-200 rounded-xl overflow-hidden mt-2
                                   focus-within:border-teal-400 focus-within:ring-2 focus-within:ring-teal-100 transition-all duration-200"
                    >
                        <input
                            type="text"
